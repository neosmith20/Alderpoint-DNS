...
class ImporterTest(unittest.TestCase):
    ...
    def test_translate_adguard_rewrites_split_local_vs_custom(self) -> None:
        ...
        self.assertIn(("nas.home.arpa", "A", "172.16.43.50"), local)
        ...
        self.assertEqual(rules["external.example.com -> 172.16.43.51"], "|external.example.com^$dnsrewrite=172.16.43.51")
        self.assertEqual(rules["*.wildcard.example -> 172.16.43.52"], "||wildcard.example^$dnsrewrite=172.16.43.52")
    ...
    def test_translate_adguard_clients(self) -> None:
        ...
        self.assertEqual(aliases, {"Phone": "172.16.43.77", "Laptop": "172.16.43.0/28"})
    ...
    def test_pihole_fixture_classification(self) -> None:
        ...
        self.assertIn("printer.home.arpa A 172.16.43.90", {i["normalized"].rsplit(" (", 1)[0] for i in local.values()})
    ...
    def test_preview_marks_local_dns_conflicts(self) -> None:
        ...
        translation = {"rewrites_as_local_dns": [{"fqdn": "conflict.home.arpa", "record_type": "A", "value": "172.16.43.11"}]}
        summary = importer.summarize_migration(translation, "home.arpa")
    ...
    def test_apply_adguard_fixture_end_to_end(self) -> None:
        ...
        with self.connect() as conn:
            ...
            self.assertEqual(local_dns.alias_for_client("172.16.43.77"), "Phone")
