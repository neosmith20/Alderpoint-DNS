<!--
SOURCE: copied verbatim from the PUBLIC repository /root/alderpointdns-public
        (origin: git@github-alderpointdns:neosmith20/Alderpoint-DNS.git)
        at public main commit de589304d1032555b7e6d02d20654b696ee7c369 (v1.1.1 release).
        Original path in that repo: docs/v2-adguard-parity-matrix.md
DO NOT EDIT this file to change its meaning. It is reference input for V2 planning,
not an output of this workstream. If V2 engineering diverges from it, document the
conflict in docs/v2/architecture-map.md instead of silently editing this copy.
-->
